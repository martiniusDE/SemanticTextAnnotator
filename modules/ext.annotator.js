...
(function () {
	...
	if (mw.config.get('wgAction') == 'view') {
		...
		// try tweekie skin
		if ($('body').hasClass('tweeki-animateLayout')) {
			// add to sidebar
			$('#sidebar-right').append('<div class="btn-group btn-block"><a href="#" id="ca-annotate" class="btn btn-primary btn-block" title="' + mw.msg('sta-button-desc') + '" accesskey="a">' + mw.msg('sta-button-text') + '</a></div>');
		} else {
			// default skin (vector)
